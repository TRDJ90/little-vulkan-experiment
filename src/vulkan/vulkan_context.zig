...
// To construct base, instance and device wrappers for vulkan-zig, we need to pass a list of 'apis' to it.
...
pub fn init(allocator: Allocator, app_name: [*:0]const u8, window: *c.GLFWwindow) !VulkanContext {
    ...
    var extensions = try std.ArrayList([*:0]const u8).initCapacity(allocator, glfw_exts_count);
